...
export class AddreviewfoodComponent implements OnInit {
  ...
  constructor(private loginService: LoginService,private snackBar: MatSnackBar,private reviewfoodService: ReviewfoodService,private router : Router,private route: ActivatedRoute) { }
  reviewfood : any =  {};
  profiles: any;
  points: Array<any>;
  message ="";
  ...
  ngOnInit() {
    ...
    save(form: NgForm) {
         ...
         data => {
            ...
            if(this.message==='{"message":"restaurant telephonenumber not null"}'){
